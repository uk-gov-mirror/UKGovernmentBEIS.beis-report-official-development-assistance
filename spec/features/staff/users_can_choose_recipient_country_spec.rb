  ...
  context "when the user is signed as a BEIS user" do
    ...
    context "with JavaScript enabled", js: true do
      ...
      scenario "typing a partial match displays all the matching countries" do
        fill_in "Country", with: "arab"

        expect(page).to have_selector "li.autocomplete__option", text: "Saudi Arabia", visible: true
        expect(page).to have_selector "li.autocomplete__option", text: "United Arab Emirates (the)", visible: true
      ...
      scenario "typing a known country displays it in the list of countries" do
      ...
      scenario "typing a complete country name, clicking it in the list and clicking continue saves the country" do
        fill_in "Country", with: "Saudi Arabia"
        find("li.autocomplete__option", text: "Saudi Arabia").click
        click_button I18n.t("form.activity.submit")
