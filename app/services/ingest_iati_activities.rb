...
class IngestIatiActivities
  ...
  private def add_planned_disbursements(legacy_activity:, roda_activity:)
    ...
    planned_disbursement_elements.each do |planned_disbursement_element|
      ...
      financial_quarter = FinancialPeriods.financial_quarter_from_date(period_start_date.to_date)
      financial_year = FinancialPeriods.financial_year_from_date(period_start_date.to_date)
