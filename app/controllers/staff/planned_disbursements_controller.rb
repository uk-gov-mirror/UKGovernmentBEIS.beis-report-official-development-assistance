...
class Staff::PlannedDisbursementsController < Staff::BaseController
  ...
  private def pre_fill_financial_quarter_and_year
    @planned_disbursement.financial_quarter = FinancialPeriods.current_financial_quarter_string
    @planned_disbursement.financial_year = FinancialPeriods.current_financial_year_string
  end
end
