    ...
    reversible do |change|
      change.up do
        ...
        planned_disbursements.each do |planned_disbursement|
          financial_quarter = FinancialPeriods.financial_quarter_from_date(planned_disbursement.period_start_date)
          financial_year = FinancialPeriods.financial_year_from_date(planned_disbursement.period_start_date)
